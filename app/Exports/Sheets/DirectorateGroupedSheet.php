...
class DirectorateGroupedSheet implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithMapping, WithTitle
{
    public $fiscalYearTitle = 'N/A';

    public function collection()
    {
        $data = PreBudget::with(['project.directorate', 'fiscalYear'])->get();
        ...
        return $data
            ->groupBy(fn ($pb) => $pb->project->directorate->title ?? 'Unknown Directorate')
            ->map(function ($items, $directorate) {
                return [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // 2. Set Main Title
                $sheet->setCellValue('A1', 'Directorate Summary');
                ...
                // Row 3: Categories
                $sheet->setCellValue('A3', 'Directorate');      // A
                ...
                // Row 4: Specifics
                $sheet->setCellValue('A4', 'Directorate Name');
