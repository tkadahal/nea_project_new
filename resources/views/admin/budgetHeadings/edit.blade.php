    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">
                {{ trans('global.budgetHeading.title') }}
            </h1>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.budgetHeading.update', $budgetHeading->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div
                        ...
                        <h3
                            ...
                            {{ trans('global.budgetHeading.title_singular') }} {{ trans('global.information') }}
                        </h3>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="{{ trans('global.budgetHeading.fields.title') }}" name="title"
                                    type="text" :value="old('title', $budgetHeading->title)" :error="$errors->first('title')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.text-area label="{{ trans('global.budgetHeading.fields.description') }}"
                                    name="description" :value="old('description', $budgetHeading->description)" :error="$errors->first('description')" />
                            </div>
                        </div>
                    </div>
