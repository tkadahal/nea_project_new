@if (!empty($capitalRows))
    @foreach ($capitalRows as $rowData)
        <tr class="projectActivity-row" data-depth="{{ $rowData['depth'] }}" data-index="{{ $rowData['index'] }}"
            ...
            <td
                ...
                @if (isset($rowData['parent_index']))
                    <input type="hidden" name="capital[{{ $rowData['index'] }}][parent_id]"
                        value="{{ $rowData['parent_index'] }}">
                @endif
                <input name="capital[{{ $rowData['index'] }}][program]" type="text"
                    value="{{ old('capital.' . $rowData['index'] . '.program', $rowData['program']) }}"
            ...
            <td class="border dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][total_budget_quantity]" type="text" min="0"
                    step="1"
                    value="{{ old('capital.' . $rowData['index'] . '.total_budget_quantity', number_format($rowData['total_budget_quantity'] ?? 0, 2)) }}"
                    placeholder="0"
            ...
            <td class="border dark:border-gray-600 px-2 py-1 text-right w-28">
                <input name="capital[{{ $rowData['index'] }}][total_budget]" type="text"
                    pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.total_budget', number_format($rowData['total_budget'] ?? 0, 2)) }}"
                    placeholder="0.00"
            ...
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][total_expense_quantity]" type="text"
                    value="{{ old('capital.' . $rowData['index'] . '.total_expense_quantity', $rowData['total_expense_quantity'] ?? '') }}"
                    placeholder="0"
            ...
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-28">
                <input name="capital[{{ $rowData['index'] }}][total_expense]" type="text"
                    pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.total_expense', $rowData['total_expense'] ?? '') }}"
                    placeholder="0.00"
                    class="w-full border-0 p-1 text-right expenses-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][planned_budget_quantity]" type="text"
                    value="{{ old('capital.' . $rowData['index'] . '.planned_budget_quantity', $rowData['planned_budget_quantity'] ?? '') }}"
                    placeholder="0"
                    class="w-full border-0 p-1 text-right planned-budget-quantity-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-28">
                <input name="capital[{{ $rowData['index'] }}][planned_budget]" type="text"
                    pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.planned_budget', $rowData['planned_budget'] ?? '') }}"
                    placeholder="0.00"
            ...
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
                <input name="capital[{{ $rowData['index'] }}][q1_quantity]" type="text" min="0"
                    step="1"
                    value="{{ old('capital.' . $rowData['index'] . '.q1_quantity', $rowData['q1_quantity'] ?? '') }}"
                    placeholder="0"
                    class="w-full border-0 p-1 text-right q1-quantity-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][q1]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.q1', $rowData['q1'] ?? '') }}" placeholder="0.00"
                    class="w-full border-0 p-1 text-right quarter-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
                <input name="capital[{{ $rowData['index'] }}][q2_quantity]" type="text" min="0"
                    step="1"
                    value="{{ old('capital.' . $rowData['index'] . '.q2_quantity', $rowData['q2_quantity'] ?? '') }}"
                    placeholder="0"
                    class="w-full border-0 p-1 text-right q2-quantity-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][q2]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.q2', $rowData['q2'] ?? '') }}" placeholder="0.00"
                    class="w-full border-0 p-1 text-right quarter-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
                <input name="capital[{{ $rowData['index'] }}][q3_quantity]" type="text" min="0"
                    step="1"
                    value="{{ old('capital.' . $rowData['index'] . '.q3_quantity', $rowData['q3_quantity'] ?? '') }}"
                    placeholder="0"
                    class="w-full border-0 p-1 text-right q3-quantity-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][q3]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.q3', $rowData['q3'] ?? '') }}" placeholder="0.00"
                    class="w-full border-0 p-1 text-right quarter-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
                <input name="capital[{{ $rowData['index'] }}][q4_quantity]" type="text" min="0"
                    step="1"
                    value="{{ old('capital.' . $rowData['index'] . '.q4_quantity', $rowData['q4_quantity'] ?? '') }}"
                    placeholder="0"
                    class="w-full border-0 p-1 text-right q4-quantity-input tooltip-error numeric-input" />
            </td>
            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
                <input name="capital[{{ $rowData['index'] }}][q4]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
                    value="{{ old('capital.' . $rowData['index'] . '.q4', $rowData['q4'] ?? '') }}"
                    placeholder="0.00"
                    class="w-full border-0 p-1 text-right quarter-input tooltip-error numeric-input" />
            </td>
            <td
                ...
                <div class="flex space-x-2 justify-center">
                    ...
                    @endif
                    @if ($rowData['depth'] > 0 || count($capitalRows) > 1)
    ...
    @endforeach
@else
    {{-- Fallback empty row (unchanged, but now totals are 0 by default) --}}
    <tr class="projectActivity-row" data-depth="0" data-index="1">
        ...
        <td
            ...
            <input name="capital[1][program]" type="text" value="{{ old('capital.1.program') }}"
                class="w-full border-0 p-1 tooltip-error" />
        </td>
        {{-- FIXED Total Budget Quantity (empty for new row) --}}
        <td class="border  dark:border-gray-600 px-2 py-1 text-right w-24">
            <input name="capital[1][total_budget_quantity]" type="text" min="0" step="1"
                value="{{ old('capital.1.total_budget_quantity') }}" placeholder="0"
                class="w-full border-0 p-1 text-right total-budget-quantity-input tooltip-error numeric-input"
                readonly />
        </td>
        {{-- FIXED Total Budget (empty for new row) --}}
        <td class="border  dark:border-gray-600 px-2 py-1 text-right w-28">
            <input name="capital[1][total_budget]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
        ...
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-28">
            <input name="capital[1][total_expense]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
        ...
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-28">
            <input name="capital[1][planned_budget]" type="text" pattern="[0-9]+(\.[0-9]{1,2})?"
                value="{{ old('capital.1.planned_budget') }}" placeholder="0.00"
                class="w-full border-0 p-1 text-right planned-budget-input tooltip-error numeric-input" />
        </td>
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
            <input name="capital[1][q1_quantity]" type="text" min="0" step="1"
                value="{{ old('capital.1.q1_quantity') }}" placeholder="0"
                class="w-full border-0 p-1 text-right q1-quantity-input tooltip-error numeric-input" />
        </td>
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
        ...
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
            <input name="capital[1][q2_quantity]" type="text" min="0" step="1"
                value="{{ old('capital.1.q2_quantity') }}" placeholder="0"
                class="w-full border-0 p-1 text-right q2-quantity-input tooltip-error numeric-input" />
        </td>
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
        ...
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
            <input name="capital[1][q3_quantity]" type="text" min="0" step="1"
                value="{{ old('capital.1.q3_quantity') }}" placeholder="0"
                class="w-full border-0 p-1 text-right q3-quantity-input tooltip-error numeric-input" />
        </td>
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
        ...
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-20">
            <input name="capital[1][q4_quantity]" type="text" min="0" step="1"
                value="{{ old('capital.1.q4_quantity') }}" placeholder="0"
                class="w-full border-0 p-1 text-right q4-quantity-input tooltip-error numeric-input" />
        </td>
        <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-right w-24">
