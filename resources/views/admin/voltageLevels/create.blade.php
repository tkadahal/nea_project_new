<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ trans('global.create') }} Voltage Level
        </p>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.voltageLevel.store') }}" method="POST">
                    @csrf
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="Voltage level" name="level" type="text" :value="old('level')"
                                    placeholder="Enter Voltage level" :error="$errors->first('level')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.input label="Value kV" name="value_kv" type="text" :value="old('value_kv')"
