<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ trans('global.edit') }} Voltage Levels
        </p>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.voltageLevel.update', $voltageLevel->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="Voltage Level Name" name="level" type="text"
                                    :value="old('level', $voltageLevel->level)" placeholder="Enter Voltage level" :error="$errors->first('level')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.input label="Value kV" name="value_kv" type="text" :value="old('value_kv', $voltageLevel->value_kv)"
                                    placeholder="Enter Voltage Value in kV" :error="$errors->first('value_kv')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.select label="Is Active" name="is_active" :options="[['value' => '1', 'label' => 'Yes'], ['value' => '0', 'label' => 'No']]" :selected="old('is_active', $voltageLevel->is_active)"
                                    :error="$errors->first('is_active')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.input label="Sort Order" name="sort_order" type="number" :value="old('sort_order', $voltageLevel->sort_order)"
