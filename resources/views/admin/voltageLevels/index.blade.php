    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">
                {{ trans('global.manage') }} Voltage Level
            </p>
        </div>

        {{-- @can('voltageLevel_create') --}}
        <a href="{{ route('admin.voltageLevel.create') }}"
    ...
    <div
        ...
        @if ($voltageLevels->isEmpty())
            <div class="p-8 text-center text-gray-500 dark:text-gray-400">
                No voltage levels found. {{ trans('global.create_new_one') }}?
            </div>
        @else
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($voltageLevels as $voltageLevel)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2 flex-wrap">
                                        @can('voltageLevel_show')
                                            <a href="{{ route('admin.voltageLevel.show', $voltageLevel) }}"
                                        ...
                                        @can('voltageLevel_delete')
                                            <form action="{{ route('admin.voltageLevel.destroy', $voltageLevel) }}"
