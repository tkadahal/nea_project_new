            ...
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <p class="mt-1 text-sm text-red-800 dark:text-red-300">
                        ...
                        activities will delay the entire project. Activities not on the critical path have slack time
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($allSchedules->sortBy('code') as $schedule)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 dark:text-gray-100">{{ $schedule->name }}</div>
                                    @if ($schedule->level > 1)
                ...
                <div class="p-6">
                    <div class="flex flex-wrap items-center gap-3">
                        @foreach ($cpm['critical_activities'] as $index => $scheduleId)
                            @php
                                $criticalSchedule = $allSchedules->get($scheduleId);
                            @endphp
