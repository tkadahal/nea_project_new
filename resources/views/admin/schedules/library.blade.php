    ...
    <div class="container-fluid px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.schedules.library.create') }}"
                    ...
                    <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-4">
                                <a href="{{ route('admin.schedules.library.create') }}?project_type={{ $typeKey }}"
                                ...
                                <div class="p-5 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <a href="{{ route('admin.schedules.library.edit', $schedule) }}"
                                            ...
                                            <form action="{{ route('admin.schedules.library.destroy', $schedule) }}"
                                                method="POST"
    ...
    @push('scripts')
        ...
        <script>
            ...
            async function saveOrder(schedules, typeKey) {
                try {
                    const res = await fetch('{{ route('admin.schedules.library.update-order') }}', {
                        method: 'POST',
                        headers: {
            ...
            async function confirmRenumber() {
                ...
                try {
                    const res = await fetch('{{ route('admin.schedules.library.renumber') }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
