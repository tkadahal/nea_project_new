<x-layouts.app>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="xl:col-span-2">
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
                    ...
                    <form action="{{ route('admin.schedules.library.store') }}" method="POST" class="p-6">
                        @csrf
    ...
    @push('scripts')
        ...
        <script>
            ...
            // ✅ FIX 2: Auto-select project type from URL parameter
            ...
            document.getElementById('project_type').addEventListener('change', function() {
                ...
                `;
                    ...
                    // Display schedules list with drag handles
                    ...
                    if (sortableList) {
                        sortableInstance = new Sortable(sortableList, {
                            ...
                            onEnd: function(evt) {
                                ...
                                // Save to server
                                saveOrder(schedules, projectType);
                            }
                        });
                    }
                }
            ...
            // ✅ FIX 1: Auto-suggest code based on parent (SILENT - no annoying alert!)
            document.getElementById('parent_id').addEventListener('change', function() {
                ...
                // Silently set the value - NO ALERT!
