<!-- resources/views/admin/budgets/partials/project-table.blade.php -->
    ...
    <tbody class="divide-y divide-gray-200 dark:divide-gray-600">
        @forelse ($projects as $index => $project)
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td class="border border-gray-300 dark:border-gray-600 px-1 py-1 text-right">
                    <input name="foreign_loan_budget[{{ $project['id'] }}]" type="number" step="0.01"
                        min="0" value="{{ old('foreign_loan_budget.' . ($project['id'] ?? ''), 0) }}"
