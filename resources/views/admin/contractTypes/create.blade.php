<x-layouts.app>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ trans('global.create') }} contract Type
        </p>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        <div class="flex-1">
            <div
                ...
                <form class="max-w-3xl mx-auto" action="{{ route('admin.contractType.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                <x-forms.input label="contract Type Name" name="name" type="text"
                                    :value="old('name')" placeholder="Enter contract type name" :error="$errors->first('name')" />
                            </div>

                            <div class="col-span-full">
                                <x-forms.input label="contract Type Code" name="code" type="text"
                                    :value="old('code')" placeholder="Enter contract type code (e.g. RD, INFRA)"
