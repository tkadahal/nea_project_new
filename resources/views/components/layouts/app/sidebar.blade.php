    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
            <ul class="space-y-1 px-2">
                                ...
                                @can('library_access')
                                    <a href="{{ route('admin.schedules.library') }}"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span>{{ trans('global.schedule.title') }}</span>
                                        </div>
                                    </a>
                                @endcan
                            </div>
                ...
                @can('budget_access')
                    <li class="js-collapsible-menu">
                        ...
                        <div
                            ...
                            @can('preBudget_access')
                                <a href="{{ route('admin.preBudget.index') }}"
                                    class="block px-3 py-2 text-sm rounded-md hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.preBudget.*') ? 'bg-sidebar-accent text-sidebar-accent-foreground' : '' }}">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- @can('task_access') --}}
                <x-layouts.sidebar-link href="{{ route('admin.schedules.overview') }}" icon="fas-pen-to-square"
                    ...
                    <li class="js-collapsible-menu">
                        <button
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    class="js-submenu-label transition-opacity duration-300 opacity-100">Reports</span>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="js-chevron h-4 w-4 transition-transform opacity-100" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
